      ...
      <div className="temp-content">
        <div className="text-section">
          ...
          <div className="temp-description">
            <h3>Short-term demands require agile solutions. Our temporary staffing services ensure you get the right talent at the right time to support your ongoing projects.</h3>
            <ul>
              <li><strong>Contract Staffing:</strong> Optimize your workforce with contract staffing. Our Consultant connect you with talented professionals who bring expertise and agility to temporary or specialized roles.</li>
