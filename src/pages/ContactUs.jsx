  ...
  return (
    <div className="contact-container">
      ...
      <div className="contact-info-section">
        ...
        <p><strong>Address:</strong> No. 1/792, 4th Street, Deivanai Nagar, Madipakkam, Chennai-600091, Tamilnadu, India.</p>
        <p><strong>Phone:</strong> <a href="tel:+918939710888">+91 8939710888</a></p>
        <p><strong>Email:</strong> <a href="mailto:admin@velaiez.com">admin@velaiez.com</a></p>
        <p><strong>Website:</strong> <a href="http://www.velaiez.com" target="_blank" rel="noopener noreferrer">www.velaiez.com</a></p>
